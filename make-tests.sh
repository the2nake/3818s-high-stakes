...
g++ -std=c++20 test-src/test-plot.cpp src/subzerolib/api/geometry/point.cpp src/subzerolib/api/geometry/segment.cpp src/subzerolib/api/geometry/circle.cpp src/subzerolib/api/util/helper.cpp src/subzerolib/api/spline/catmull-rom.cpp -isystemvendor/include -Iinclude -DEIEN_DONT_VECTORIZE -o test-output/test-plot.bin
