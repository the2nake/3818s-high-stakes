...
template <>
inline cholmod_dense *cm_solve<SuiteSparse_long>(int sys,
                                                 cholmod_factor &L,
                                                 cholmod_dense &B,
...
template <typename _StorageIndex>
inline cholmod_sparse *cm_spsolve(int sys,
                                  cholmod_factor &L,
                                  cholmod_sparse &B,
                                  cholmod_common &Common) {
...
template <>
inline cholmod_sparse *cm_spsolve<SuiteSparse_long>(int sys,
                                                    cholmod_factor &L,
                                                    cholmod_sparse &B,
                                                    cholmod_common &Common) {
...
template <typename _StorageIndex>
inline int cm_factorize_p(cholmod_sparse *A,
                          double beta[2],
                          _StorageIndex *fset,
                          std::size_t fsize,
                          cholmod_factor *L,
...
template <>
inline int cm_factorize_p<SuiteSparse_long>(cholmod_sparse *A,
                                            double beta[2],
...
public:
  ...
  void factorize(const MatrixType &matrix) {
    ...
    cholmod_sparse A = viewAsCholmod(matrix.template selfadjointView<UpLo>());
    internal::cm_factorize_p<StorageIndex>(
        &A, m_shiftOffset, 0, 0, m_cholmodFactor, m_cholmod);
  ...
  void _solve_impl(const SparseMatrixBase<RhsDerived> &b,
    ...
    Ref<SparseMatrix<typename RhsDerived::Scalar,
                     ColMajor,
    ...
    dest.derived() = viewAsEigen<typename DestDerived::Scalar,
                                 ColMajor,
...
class CholmodSimplicialLLT
    : public CholmodBase<_MatrixType,
                         _UpLo,
